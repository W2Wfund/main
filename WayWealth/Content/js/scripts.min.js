        ...
        $.bandClock = function (el, options) {
            ...
            renderTime = (function (_this) {
                return function () {
                    ...
                    now = new Date();
                    now.setTime(now.getTime() + now.getTimezoneOffset() * 60000 + $(el).closest('.band-clock').attr('data-timezone') * 3600000);
                    hours = now.getHours();
